...
def show_single_invoice_preview(invoice_data, key_suffix=""):
    ...
    html += '<div style="background:#fff;padding:15px;border-radius:8px;margin-bottom:15px;"><div style="font-size:24px;font-weight:bold;color:#0066b2;border-bottom:2px solid #0066b2;padding-bottom:10px;">RECEIPT / TAX INVOICE</div>'
    ...
    html += '<div style="font-size:11px;">Tax ID: 0105535169497 | Tel: 02-650-7400</div></div>'
